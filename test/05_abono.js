...
contract('Temporada Compra y Alquiler', (accounts) => {
  ...
  it('Se debería haber creado un segundo espectáculo', async () => {
    const temporadaInstance = await Temporada.deployed();
  ...
  it('Un usuario intenta alquilar un abono a abonado no alquilable', async () => {
    const temporadaInstance = await Temporada.deployed();
